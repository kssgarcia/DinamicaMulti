...
class  CoordenadasNaturales:
    def __init__(self,win1, win2, win3, win4, app, I1, I2, I3, I4, phi_1, phi2inicial, omega2inicial, alpha2inicial, time_simul):
    ...
    def SolucionNaturales(self):
        ...
        phi = [[ pow((x1-x0),2) + pow((y1-y0),2) - pow(self.I2,2)],
        ...
        for i in np.arange(0, self.time_simul, step):
            ...
            v_1 = [0, 0, 0, 0, 0, 0, 0, self.I2*(self.alpha2inicial*i+self.omega2inicial)*sin(0.5*pow(self.alpha2inicial*i,2) + self.omega2inicial*i + self.phi2inicial)]
