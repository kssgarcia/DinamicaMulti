...
class  CierreVectorial:
    ...
    def SolucionVectorial(self, I1, I2, I3, I4, phi2inicial, omega2inicial, alpha2inicial, time_simul):
        ...
        for i in np.arange(0, time_simul, step):
            ...
            rest = 10
            while rest > 0.00001:
                # phiEval = phi.subs(dict(x1=x[0][0], y1=x[1][0], phi1=x[2][0], x2=x[3][0], y2=x[4][0], phi2=x[5][0], x3=x[6][0], y3=x[7][0], phi3=x[8][0], x4=x[9][0], y4=x[10][0], phi4=x[11][0], t=i))
                ...
                phiSys = np.array(phi.subs(dict(x1=x[0][0], y1=x[1][0], phi1=x[2][0], x2=x[3][0], y2=x[4][0], phi2=x[5][0], x3=x[6][0], y3=x[7][0], phi3=x[8][0], x4=x[9][0], y4=x[10][0], phi4=x[11][0], t=i))).astype(float)
                jacobianEval = np.array(jaco.subs(dict(x1=x[0][0], y1=x[1][0], phi1=x[2][0], x2=x[3][0], y2=x[4][0], phi2=x[5][0], x3=x[6][0], y3=x[7][0], phi3=x[8][0], x4=x[9][0], y4=x[10][0], phi4=x[11][0], t=i))).astype(float)
